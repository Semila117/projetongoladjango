"""
Django settings for ngola project.
...
ALLOWED_HOSTS = ["https://projetongoladjango-production.up.railway.app/", "localhost", "http://127.0.0.1" ]
...
WSGI_APPLICATION = 'ngola.wsgi.application'
